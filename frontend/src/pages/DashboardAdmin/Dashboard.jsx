    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="relative rounded-[24px] overflow-hidden min-h-[140px] flex items-center">
        ...
        <div className="relative z-10 flex items-center justify-between w-full px-8 py-6 gap-6">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <button onClick={() => navigate("/admin/activities")} className="h-[38px] px-5 rounded-full bg-white text-[#2F343B] text-sm font-semibold hover:bg-gray-100 transition-colors">
              Create activity
            </button>
          </div>
        </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <button onClick={() => navigate("/admin/activities")} className="text-xs text-[#ED8D31] font-semibold hover:opacity-80">Open full management area</button>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-5">
              ...
              <div className="flex flex-col gap-3">
                {[
                  ...
                  <div key={d.name} className="flex items-center gap-3">
                    ...
                    <button onClick={() => navigate("/dashboard/documents")} className="shrink-0 h-[26px] px-3 rounded-full bg-[#ED8D31] text-white text-[10px] font-semibold hover:bg-[#d47d29]">
                      Upload
                    </button>
                  </div>
                ))}
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="rounded-[20px] bg-[#ED8D31] p-5">
            ...
            <button onClick={() => navigate("/admin/activities")} className="w-full h-[36px] rounded-full bg-white text-[#ED8D31] text-xs font-bold hover:bg-orange-50 transition-colors">
              Open admin tools
            </button>
          </div>
